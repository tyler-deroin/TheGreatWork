...
lr <- lrr %>% filter(!is.na(social_grade), !is.na(education), !(education == 16), !is.na(religion), !is.na(children))
dim(lrr)
...
confusionMatrix(testData$separated)


# manually testing the accuracy
pred_1 <- ifelse(predicted3 > mean(as.numeric(testData$separated)), 1, 0)
 
# Calculate the model's accuracy
mean(testData$separated == pred_1)
